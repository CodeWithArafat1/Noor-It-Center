...
const processData = {
  sectionMeta: {
    tagline: "LEARNING PROCESS",

    title: (
      <>
        How We Teach<span className="text-[#00B87A]"> Our Students</span>
      </>
    ),
    description:
      "Our practical learning approach helps students gain real-world skills from beginner to professional level.",
  },
  steps: [
    {
      id: 1,
      ...
      description:
        "We start from the absolute basics, ensuring every student understands the core concepts before moving to advanced topics.",
    },
    {
      id: 2,
      stepNumber: "02",
      ...
      description:
        "Every topic is taught through live coding and hands-on practice so students can build confidence with real examples.",
    },
    {
      id: 3,
      stepNumber: "03",
      ...
      description:
        "Students complete regular assignments, quizzes, and practical exercises to strengthen their knowledge and problem-solving skills.",
    },
    {
      id: 4,
      stepNumber: "04",
      ...
      description:
        "Students work on industry-standard projects that simulate real client requirements and build a professional portfolio.",
    },
    {
      id: 5,
      stepNumber: "05",
      ...
      description:
        "We provide portfolio guidance, CV preparation, interview practice, and career support to help students become job and freelancing ready.",
    },
  ],
};
          ...
          <div className="relative z-10 flex flex-col gap-12 md:gap-0">
            {processData.steps.map((step, index) => {
              ...
              const activationPoint =
                index * (1 / (processData.steps.length - 1 || 1));
  ...
  return (
    <div
      className={`bg-white border rounded-2xl p-6 md:p-8 w-full max-w-lg transition-all duration-500 hover:-translate-y-1 ${
        isActive
          ? "border-[#00B87A]/40 shadow-xl shadow-[#00B87A]/5"
